document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function fetchServicios() {
        try {
            const response = await fetch('https://9plm87v2-3000.brs.devtunnels.ms/api/servicios');
    ...
    async function fetchCombos() {
        try {
            const response = await fetch("https://9plm87v2-3000.brs.devtunnels.ms/api/combos");
